...
/**
 * Vista que Actualiza cita de la persona
 * @author Denis Abad
 */
public class ActualizarCita extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        cita.setNombre(jTextField2.getText());              
        cita.setDpi(jTextField3.getText());                 
        cita.setFecha(jTextField6.getText());        
        cita.setHora(jTextField7.getText());
        
        controlador.actualizarCita(jTextField1.getText(), cita); 
         jTextField1.setText("");
        jTextField2.setText("");
           jTextField3.setText("");
            jTextField6.setText("");
